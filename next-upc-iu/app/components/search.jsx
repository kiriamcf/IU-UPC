  ...
  return (
    <div className='relative group w-56'>
      <div className='py-2 flex items-center gap-2 text-sm text-gray-400 border-b-2 border-gray-400'>
        ...
        <input className='bg-transparent focus:outline-none placeholder-gray-400 focus:text-gray-50 valid:text-gray-50' type='text' placeholder={placeholder} value={value} onChange={e => setValue(e.target.value)}/>
      </div>
